...
{
    public partial class Wenner2D_Option : Form
    {
        Main_Form main1;
        public Wenner2D_Option(Main_Form main)
        {
            InitializeComponent();
            main1 = main;
        }
        ...
        private void Wenner2D_Option_Load(object sender, EventArgs e)
        {
            try {
                pathtofile = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                Wenner2D_Form wen2 = new Wenner2D_Form(MyDataString, pathtofile, inforadio, selected, poz_int);
