...
{
    public partial class Wenner1D_Options : Form
    {
        Main_Form main1;
        public Wenner1D_Options(Main_Form main)
        {
            InitializeComponent();
            main1 = main;
        }
        ...
        private void Wenner1D_Options_Load(object sender, EventArgs e)
        {
            try {
                pathtofile = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                Wenner1D_Form wen2 = new Wenner1D_Form(MyDataString, pathtofile, inforadio, selected, poz_int);
                wen2.MdiParent = main1;
                wen2.WindowState = FormWindowState.Maximized;
                wen2.Show();
                this.Close();
            }
            catch (Exception ex)
