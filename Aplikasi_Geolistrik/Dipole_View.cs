...
namespace Aplikasi_Geolistrik
{
    ...
    public partial class Dipole_View : Form
    {
        double[] dis;
        double[] n;
        public Dipole_View(double[] d, double[] r)
        {
            InitializeComponent();
            dis = d;
            n = r;
        ...
        private void Dipole_View_Load(object sender, EventArgs e)
        {
            try {
                ...
                {
                    chart1.Series["Datum View"].Points.AddXY(dis[i], n[i]);
                }
            }
            catch (Exception ex)
            {
